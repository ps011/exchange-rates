        ...
        <footer className="bg-white rounded-lg shadow dark:bg-gray-900 relative bottom-0 right-0 left-0">
            ...
            <div className="mx-auto p-4 flex flex-col sm:flex-row sm:w-full">
                ...
                <div
                    ...
                    <a href="https://instagram.com/ps.11" target="_blank" className="text-black dark:text-white no-underline sm:ml-4">
                        <span onClick={() => {
                    ...
                    <a href="https://github.com/ps011" target="_blank" className="text-black dark:text-white no-underline sm:ml-4">
                        <span onClick={() => {
                    ...
                    <a href="https://x.com/soniprasheel" target="_blank" className="text-black dark:text-white no-underline sm:ml-4">
                         <span onClick={() => {
                             logLinkClickEvent("github")
                         }}>
                    ...
                    <a href="https://linkedin.com/in/ps011" target="_blank" className="text-black dark:text-white no-underline sm:ml-4">
                         <span onClick={() => {
                             logLinkClickEvent("github")
                         }}>
